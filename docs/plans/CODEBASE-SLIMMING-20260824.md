...
| 收尾文档(本记录 + 联合审后修) | `da362acc` `8d54ac7c` `d097a378` `737f52f0` `0f91461f` | docs-only(本节 + catalog.md 生效路径如实化) |

口径:审计文档落库 commit `15b2424f` `30ae9770`(见上注)不计入批次表;本表之后若再有纯补表 docs commit 亦不回填(避免自引用递归),以 `git log e1068f4c..HEAD` 为完整清单。
